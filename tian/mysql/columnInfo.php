...
// ------ ---------------- ------ ------ ------- --------
// pk1 int(10) unsigned NO PRI (NULL)
// pk2 int(10) unsigned NO PRI (NULL)
...
class columnInfo {
	 ...
	 */
	public function __construct(PDO $connection, $tabname, $columnname) {
